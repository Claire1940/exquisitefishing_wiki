...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Exquisite Fishing Wiki',
    description: 'Copyright and intellectual property information for Exquisite Fishing Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Exquisite Fishing Wiki',
      description: 'Copyright and intellectual property information for Exquisite Fishing Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Exquisite Fishing Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Exquisite Fishing Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Exquisite Fishing Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>PinkySoul</strong> - Developer of the Exquisite Fishing game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Exquisite Fishing</strong> - Trademark of PinkySoul</li>
              <li><strong>Exquisite Fishing Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Exquisite Fishing Wiki.
            </p>
            ...
            <p>
              ...
              Exquisite Fishing Wiki<br />
              Email: <a href="mailto:dmca@exquisitefishing.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@exquisitefishing.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Exquisite Fishing Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Exquisite Fishing Wiki (exquisitefishing.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@exquisitefishing.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@exquisitefishing.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@exquisitefishing.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@exquisitefishing.wiki</a>
            </p>
            <p>

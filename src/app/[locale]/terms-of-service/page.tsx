...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.exquisitefishing.wiki'
  const path = '/terms-of-service'

  return {
    title: "Terms of Service - Exquisite Fishing Wiki",
    description: "Read the Terms of Service for Exquisite Fishing Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Steam game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: "Exquisite Fishing Wiki",
      title: "Terms of Service - Exquisite Fishing Wiki",
      description: "Terms and conditions for using Exquisite Fishing Wiki.",
      images: [
        {
          url: `${siteUrl}/images/hero.webp`,
          width: 1200,
          height: 630,
          alt: "Exquisite Fishing Wiki",
        },
      ],
    },
    twitter: {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Exquisite Fishing Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Exquisite Fishing Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Exquisite Fishing Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Exquisite Fishing Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Steam game "Exquisite Fishing". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Walkthroughs and progression guides</li>
              <li>Gear, hook, and boat upgrade guides</li>
              <li>Ocean biome and depth information</li>
              <li>Fish, creature, and character guides</li>
              <li>Scene unlock and gallery guides</li>
              <li>Save file and troubleshooting help</li>
            </ul>
            <p>
              <strong>Important:</strong> Exquisite Fishing Wiki is NOT affiliated with, endorsed by, or associated with
              Valve Corporation (Steam) or the official developers of Exquisite Fishing. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Exquisite Fishing Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Valve Corporation (Steam) and/or the developers of Exquisite Fishing. We use such
            ...
            <ul>
              ...
              <li><strong>Game Availability:</strong> Game updates, pricing, and content may change without notice. We are not responsible for game changes or access issues.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, EXQUISITE FISHING WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Exquisite Fishing Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@exquisitefishing.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@exquisitefishing.wiki</a>
            </p>
            <p>
